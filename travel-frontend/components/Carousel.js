...
export default function Carousel() {
  ...
  return (
    ...
    <Image src={featuredPlaces[currentIndex]} alt="Places to visit" ref={carouselRef} className=" cursor-pointer rounded-md sm:h-2/3 sm:w-4/5 sm:aspect-video lg:h-1/5 lg:w-5/12 lg:mx-auto lg:mb-8 hover:opacity-70 justify-center" />
    <div className=" absolute w-full top-1/2 transform -translate-y-1/2 px-3 flex justify-between items-center">

    <img src='/left-arrow.png' onClick={handleOnClickPrev}  className= "opacity-80 h-12  pl-1  hover:opacity-50 transition cursor-pointer"/>
    <img src='/right-arrow.png' onClick={handleOnClickNext} className= "opacity-80 h-12  pl-1  hover:opacity-50 transition cursor-pointer" />
